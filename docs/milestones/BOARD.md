...
| 13 | `M0-26` Dockerfiles `M0:165` | `area:infra` | sayfeldinn+Hana | `M0-20,25` |
| 14 | `M0-27` `infra/docker-compose.yml` `M0:166` | `area:infra` | sayfeldinn+Hana | `M0-26,8` |
...
| 21 | `M0-34` retro + planning `M0:182` | `area:infra` | sayfeldinn | `M0-28,31` |

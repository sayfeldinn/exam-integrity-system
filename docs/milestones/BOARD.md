...
| **This Sprint** `M0:119` ≤8 | seeded per `BOARD_SETUP.md:32-35` — *reassigned 2026-09-03* | `#1` `M0-14` `area:api` **Leader+Moatasem** `M0:131` FastAPI project · `#8` `M0-21` `area:web` `Adel` `M0:149` Next.js |
...
|---|---|---|---|---|
| 1 | `M0-14` Initialize FastAPI `services/api` `M0:131` | `area:api` | **Leader+Moatasem** | `M0-9,M0-8` |
| 2 | `M0-15` `core/config.py` `pydantic-settings` `M0:132` | `area:api` | **Leader+Moatasem** | `M0-14,M0-8` |
| 3 | `M0-16` `GET /api/v1/health` + `CORSMiddleware` `M0:133` | `area:api` | **Leader+Moatasem** | `M0-14` |
| 4 | `M0-17` Postgres `asyncpg` `M0:134` | `area:api` | **Leader+Moatasem** | `M0-15` |

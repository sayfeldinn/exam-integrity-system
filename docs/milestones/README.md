...
|---|---|---|---|---|
| M0 | [`M0_IMPLEMENTATION_PLAN.md`](./M0_IMPLEMENTATION_PLAN.md) | Week 1–2 | Skeleton, `services/api` + `apps/web` scaffolded, Ruleset, `docker compose up` on 2 OSes | **Phase 1 complete** `2026-09-03` — `M0-1..M0-13` repo foundation done (`dcad3a0` `v0.0.1` + `c7310bf` `v0.0.2` + `f15a28c` `v0.0.3` + `1858f1b` `v0.0.4` + this `phase1-complete`) — DoD `M0:21-96` Phase 1 portion green, `M0-14..M0-34` seeded `This Sprint`/`Backlog` for `Day 2-4` |
...
- Tagging: milestone tags `m{0..6}-{slug}` + semver `v0.1.0` … `v1.0.0` — `Admin`-only via **Tag protection** `Settings → Tags → New tag protection rule` patterns `v*`, `m*` (see `docs/PROJECT_CONTEXT.md:9` 2026-09-03). Current: `v0.0.1` `dcad3a0`, `v0.0.2` `c7310bf`, `v0.0.3` `f15a28c`, `v0.0.4` `1858f1b`, `phase1-complete` (this commit) + `v0.1.0` reference for Phase 1.
